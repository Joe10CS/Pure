// Autogenerated with StateSmith 0.18.0+34a94a5de0bf3f5f53012c58cebeef3eea5dac04. Last run: 2025-08-31 03:55:29 PM.
...
static void STATE_GUIMODEWAITCOMMANDS_do(SMSodaStreamPure* sm);
...
static void STATE_SENDDONEONSTOP_enter(SMSodaStreamPure* sm);

static void STATE_SENDDONEONSTOP_exit(SMSodaStreamPure* sm);

static void STATE_SENDDONEONSTOP_do(SMSodaStreamPure* sm);
...
static void SATE_START_CARBONATING_ONLY_enter(SMSodaStreamPure* sm);

static void SATE_START_CARBONATING_ONLY_exit(SMSodaStreamPure* sm);

static void SATE_START_CARBONATING_ONLY_do(SMSodaStreamPure* sm);
...
static void STATE_FILTERINGCARBONATIONAWAIT_do(SMSodaStreamPure* sm);
    ...
    switch (sm->state_id)
    {
        ...
        case SMSodaStreamPure_StateId_STATE_GUIMODEWAITCOMMANDS:
            switch (event_id)
            {
                ...
                case SMSodaStreamPure_EventId_DO: STATE_GUIMODEWAITCOMMANDS_do(sm); break;
        ...
        // STATE: State_SendDoneOnStop
        case SMSodaStreamPure_StateId_STATE_SENDDONEONSTOP:
            switch (event_id)
            {
                case SMSodaStreamPure_EventId_DO: STATE_SENDDONEONSTOP_do(sm); break;
                case SMSodaStreamPure_EventId_EVENT_HWWATCHDOG: STAT_GUICONTROLMODE_event_hwwatchdog(sm); break; // First ancestor handler for this event
                case SMSodaStreamPure_EventId_EVENT_SAFETYFAIL: STAT_GUICONTROLMODE_event_safetyfail(sm); break; // First ancestor handler for this event
                case SMSodaStreamPure_EventId_EVENT_EXIT_GUI_CONTROLLED_MODE: STAT_GUICONTROLMODE_event_exit_gui_controlled_mode(sm); break; // First ancestor handler for this event
        ...
        // STATE: Sate_Start_Carbonating_only
        case SMSodaStreamPure_StateId_SATE_START_CARBONATING_ONLY:
            switch (event_id)
            {
                case SMSodaStreamPure_EventId_DO: SATE_START_CARBONATING_ONLY_do(sm); break;
                case SMSodaStreamPure_EventId_EVENT_HWWATCHDOG: STATE_AUTOMATICMODE_event_hwwatchdog(sm); break; // First ancestor handler for this event
                case SMSodaStreamPure_EventId_EVENT_SAFETYFAIL: STATE_AUTOMATICMODE_event_safetyfail(sm); break; // First ancestor handler for this event
                case SMSodaStreamPure_EventId_EVENT_TILTDETECTED: STATE_AUTOMATICMODE_event_tiltdetected(sm); break; // First ancestor handler for this event
                case SMSodaStreamPure_EventId_EVENT_ENTER_GUI_CONTROLLED_MODE: STATE_AUTOMATICMODE_event_enter_gui_controlled_mode(sm); break; // First ancestor handler for this event
        ...
        case SMSodaStreamPure_StateId_STATE_FILTERINGCARBONATIONAWAIT:
            switch (event_id)
            {
                ...
                case SMSodaStreamPure_EventId_DO: STATE_FILTERINGCARBONATIONAWAIT_do(sm); break;
...
static void exit_up_to_state_handler(SMSodaStreamPure* sm, SMSodaStreamPure_StateId desired_state)
{
    while (sm->state_id != desired_state)
    {
        switch (sm->state_id)
        {
            ...
            case SMSodaStreamPure_StateId_STATE_SENDDONEONSTOP: STATE_SENDDONEONSTOP_exit(sm); break;
            ...
            case SMSodaStreamPure_StateId_SATE_START_CARBONATING_ONLY: SATE_START_CARBONATING_ONLY_exit(sm); break;
...
static void STATE_GUIMODEWAITCOMMANDS_do(SMSodaStreamPure* sm)
{
    ...
    // uml: do [IsBottleFull()] TransitionTo(Stat_GUIControlMode.<ChoicePoint>())
    if (IsBottleFull())
    {
        // Step 1: Exit states until we reach `Stat_GUIControlMode` state (Least Common Ancestor for transition).
...
{
    // State_GuiModeWaitCommands behavior
    // uml: Event_STOP TransitionTo(Stat_GUIControlMode.<ChoicePoint>())
    {
        // Step 1: Exit states until we reach `Stat_GUIControlMode` state (Least Common Ancestor for transition).
        STATE_GUIMODEWAITCOMMANDS_exit(sm);
        ...
        // Stat_GUIControlMode.<ChoicePoint>() behavior
        // uml: [pumpStopsOnSensor] TransitionTo(State_SendDoneOnStop)
        if (sm->vars.pumpStopsOnSensor)
        {
            // Step 1: Exit states until we reach `Stat_GUIControlMode` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            ...
            // Step 3: Enter/move towards transition target `State_SendDoneOnStop`.
            STATE_SENDDONEONSTOP_enter(sm);
        ...
        // Stat_GUIControlMode.<ChoicePoint>() behavior
        // uml: else TransitionTo(State_Stop)
        {
            // Step 1: Exit states until we reach `Stat_GUIControlMode` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
...
////////////////////////////////////////////////////////////////////////////////
// event handlers for state STATE_SENDDONEONSTOP
////////////////////////////////////////////////////////////////////////////////

static void STATE_SENDDONEONSTOP_enter(SMSodaStreamPure* sm)
{
    sm->state_id = SMSodaStreamPure_StateId_STATE_SENDDONEONSTOP;
    
    // State_SendDoneOnStop behavior
    // uml: enter / { pumpStopsOnSensor = false; }
    {
        // Step 1: execute action `pumpStopsOnSensor = false;`
        sm->vars.pumpStopsOnSensor = false;
    } // end of behavior for State_SendDoneOnStop
...
{
    // State_SendDoneOnStop behavior
    // uml: do TransitionTo(State_Stop)
    {
        // Step 1: Exit states until we reach `Stat_GUIControlMode` state (Least Common Ancestor for transition).
        STATE_SENDDONEONSTOP_exit(sm);
...
////////////////////////////////////////////////////////////////////////////////
// event handlers for state SATE_START_CARBONATING_ONLY
////////////////////////////////////////////////////////////////////////////////

static void SATE_START_CARBONATING_ONLY_enter(SMSodaStreamPure* sm)
{
    sm->state_id = SMSodaStreamPure_StateId_SATE_START_CARBONATING_ONLY;
    
    // Sate_Start_Carbonating_only behavior
    // uml: enter / { InitCarbonationOnly(); }
    {
        // Step 1: execute action `InitCarbonationOnly();`
        InitCarbonationOnly();
    } // end of behavior for Sate_Start_Carbonating_only
    
    // Sate_Start_Carbonating_only behavior
    // uml: enter / { SetLevelLed(); }
    {
        // Step 1: execute action `SetLevelLed();`
        SetLevelLed();
    } // end of behavior for Sate_Start_Carbonating_only
...
static void SATE_START_CARBONATING_ONLY_do(SMSodaStreamPure* sm)
{
    ...
    {
        // Step 1: Exit states until we reach `State_AutomaticMode` state (Least Common Ancestor for transition).
        SATE_START_CARBONATING_ONLY_exit(sm);
...
{
    // State_Filtering behavior
    // uml: do [IsBottleFull()] TransitionTo(State_ExitFilteringOnly)
    if (IsBottleFull())
    {
        // Step 1: Exit states until we reach `State_AutomaticMode` state (Least Common Ancestor for transition).
...
{
    // State_FilteringCarbonationAwait behavior
    // uml: do [IsBottleFull()] TransitionTo(State_Carbonating)
    if (IsBottleFull())
    {
        // Step 1: Exit states until we reach `State_AutomaticMode` state (Least Common Ancestor for transition).
...
static void STATE_POWERON_event_carbonationlevelpressed(SMSodaStreamPure* sm)
{
    ...
    // uml: Event_CarbonationLevelPressed TransitionTo(Sate_Start_Carbonating_only)
    {
        // Step 1: Exit states until we reach `State_AutomaticMode` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(sm, SMSodaStreamPure_StateId_STATE_AUTOMATICMODE);
        ...
        // Step 3: Enter/move towards transition target `Sate_Start_Carbonating_only`.
        SATE_START_CARBONATING_ONLY_enter(sm);
...
static void STATE_POWERONINIT_enter(SMSodaStreamPure* sm)
{
    ...
    // uml: enter / { StopAllHW(); }
    {
        // Step 1: execute action `StopAllHW();`
        StopAllHW();
    } // end of behavior for State_PowerOnInit
}
...
{
    // State_Rinsing behavior
    // uml: do [IsBottleFull()] TransitionTo(State_Ready)
    if (IsBottleFull())
    {
        // Step 1: Exit states until we reach `State_AutomaticMode` state (Least Common Ancestor for transition).
