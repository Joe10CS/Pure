// Autogenerated with StateSmith 0.18.0+34a94a5de0bf3f5f53012c58cebeef3eea5dac04. Last run: 2025-10-30 04:02:37 PM.
...
static void SATE_CARBLEDS_enter(SMSodaStreamPure* sm);

static void SATE_CARBLEDS_exit(SMSodaStreamPure* sm);

static void SATE_CARBLEDS_do(SMSodaStreamPure* sm);
...
static void SATE_FILTERTOCARBDELAY_enter(SMSodaStreamPure* sm);

static void SATE_FILTERTOCARBDELAY_exit(SMSodaStreamPure* sm);

static void SATE_FILTERTOCARBDELAY_do(SMSodaStreamPure* sm);
...
void SMSodaStreamPure_dispatch_event(SMSodaStreamPure* sm, SMSodaStreamPure_EventId event_id)
{
    switch (sm->state_id)
    {
        ...
        // STATE: Sate_CarbLeds
        case SMSodaStreamPure_StateId_SATE_CARBLEDS:
            switch (event_id)
            {
                case SMSodaStreamPure_EventId_DO: SATE_CARBLEDS_do(sm); break;
                case SMSodaStreamPure_EventId_EVENT_HWWATCHDOG: STATE_AUTOMATICMODE_event_hwwatchdog(sm); break; // First ancestor handler for this event
                case SMSodaStreamPure_EventId_EVENT_SAFETYFAIL: STATE_AUTOMATICMODE_event_safetyfail(sm); break; // First ancestor handler for this event
                case SMSodaStreamPure_EventId_EVENT_ENTER_GUI_CONTROLLED_MODE: STATE_AUTOMATICMODE_event_enter_gui_controlled_mode(sm); break; // First ancestor handler for this event
        ...
        // STATE: Sate_FilterToCarbDelay
        case SMSodaStreamPure_StateId_SATE_FILTERTOCARBDELAY:
            switch (event_id)
            {
                case SMSodaStreamPure_EventId_DO: SATE_FILTERTOCARBDELAY_do(sm); break;
                case SMSodaStreamPure_EventId_EVENT_HWWATCHDOG: STATE_AUTOMATICMODE_event_hwwatchdog(sm); break; // First ancestor handler for this event
                case SMSodaStreamPure_EventId_EVENT_SAFETYFAIL: STATE_AUTOMATICMODE_event_safetyfail(sm); break; // First ancestor handler for this event
                case SMSodaStreamPure_EventId_EVENT_ENTER_GUI_CONTROLLED_MODE: STATE_AUTOMATICMODE_event_enter_gui_controlled_mode(sm); break; // First ancestor handler for this event
                case SMSodaStreamPure_EventId_EVENT_ANYKEYPRESS: STATE_CARBONATING_event_anykeypress(sm); break; // First ancestor handler for this event
...
static void exit_up_to_state_handler(SMSodaStreamPure* sm, SMSodaStreamPure_StateId desired_state)
{
    while (sm->state_id != desired_state)
    {
        switch (sm->state_id)
        {
            ...
            case SMSodaStreamPure_StateId_SATE_CARBLEDS: SATE_CARBLEDS_exit(sm); break;
            ...
            case SMSodaStreamPure_StateId_SATE_FILTERTOCARBDELAY: SATE_FILTERTOCARBDELAY_exit(sm); break;
...
static void STATE_AWAKE_event_primarybuttonpressed(SMSodaStreamPure* sm)
{
    ...
    // uml: Event_PrimaryButtonPressed TransitionTo(State_AutomaticMode.<ChoicePoint>())
    {
        ...
        if (IsBottleFull())
        {
            ...
            // State_AutomaticMode.<ChoicePoint>() behavior
            // uml: [CarbonationEnabled()] TransitionTo(Sate_CarbLeds)
            if (CarbonationEnabled())
            {
                ...
                // Step 3: Enter/move towards transition target `Sate_CarbLeds`.
                STATE_CARBONATING_enter(sm);
                SATE_CARBLEDS_enter(sm);
...
////////////////////////////////////////////////////////////////////////////////
// event handlers for state SATE_CARBLEDS
////////////////////////////////////////////////////////////////////////////////

static void SATE_CARBLEDS_enter(SMSodaStreamPure* sm)
{
    sm->state_id = SMSodaStreamPure_StateId_SATE_CARBLEDS;
    
    // Sate_CarbLeds behavior
    ...
    } // end of behavior for Sate_CarbLeds
}
...
////////////////////////////////////////////////////////////////////////////////
// event handlers for state SATE_FILTERTOCARBDELAY
////////////////////////////////////////////////////////////////////////////////

static void SATE_FILTERTOCARBDELAY_enter(SMSodaStreamPure* sm)
{
    sm->state_id = SMSodaStreamPure_StateId_SATE_FILTERTOCARBDELAY;
    
    // Sate_FilterToCarbDelay behavior
    // uml: enter / { StartFilterToCarbDelay(); }
    {
        // Step 1: execute action `StartFilterToCarbDelay();`
        StartFilterToCarbDelay();
    } // end of behavior for Sate_FilterToCarbDelay
}
...
static void SATE_FILTERTOCARBDELAY_do(SMSodaStreamPure* sm)
{
    ...
    // Sate_FilterToCarbDelay behavior
    // uml: do [FilterToCarbDelayDone()] TransitionTo(Sate_Start_Carbonating)
    if (FilterToCarbDelayDone())
    {
        // Step 1: Exit states until we reach `State_Carbonating` state (Least Common Ancestor for transition).
        SATE_FILTERTOCARBDELAY_exit(sm);
...
static void STATE_FILTERING_do(SMSodaStreamPure* sm)
{
    ...
    if (IsBottleFull())
    {
        ...
        // State_AutomaticMode.<ChoicePoint>() behavior
        // uml: [CarbonationEnabled()] TransitionTo(Sate_FilterToCarbDelay)
        if (CarbonationEnabled())
        {
            // Step 1: Exit states until we reach `State_AutomaticMode` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            ...
            // Step 3: Enter/move towards transition target `Sate_FilterToCarbDelay`.
            STATE_CARBONATING_enter(sm);
            SATE_FILTERTOCARBDELAY_enter(sm);
