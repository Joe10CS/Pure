// Autogenerated with StateSmith 0.18.0+34a94a5de0bf3f5f53012c58cebeef3eea5dac04. Last run: 2025-11-14 06:25:26 PM.
...
static void State_Awake_ChoicePoint__transition(SMSodaStreamPure* sm)
{
    ...
    // uml: [IsInFilterReplacementWarningPeriod()||IsFilterExpired()] TransitionTo(State_ReadyRinseRequired)
    if (IsInFilterReplacementWarningPeriod()||IsFilterExpired())
    {
