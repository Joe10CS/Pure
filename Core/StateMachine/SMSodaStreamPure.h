// Autogenerated with StateSmith 0.18.0+34a94a5de0bf3f5f53012c58cebeef3eea5dac04. Last run: 2025-08-22 02:35:49 PM.
...
typedef enum SMSodaStreamPure_EventId
{
    ...
    SMSodaStreamPure_EventId_EVENT_CARBONATIONLEVELPRESSED = 3,
    SMSodaStreamPure_EventId_EVENT_ENTER_GUI_CONTROLLED_MODE = 4,
    SMSodaStreamPure_EventId_EVENT_EXIT_GUI_CONTROLLED_MODE = 5,
    SMSodaStreamPure_EventId_EVENT_HWWATCHDOG = 6,
    SMSodaStreamPure_EventId_EVENT_LONGPRESSWATERFILTER = 7,
    SMSodaStreamPure_EventId_EVENT_NOTTILTED = 8,
    SMSodaStreamPure_EventId_EVENT_READYTIMOUT = 9,
    SMSodaStreamPure_EventId_EVENT_SAFETYFAIL = 10,
    SMSodaStreamPure_EventId_EVENT_SHORTPRESSWATERFILTER = 11,
    SMSodaStreamPure_EventId_EVENT_TILTDETECTED = 12,
...
typedef enum SMSodaStreamPure_StateId
{
    ...
    SMSodaStreamPure_StateId_SATE_START_CARBONATING_ONLY = 9,
    SMSodaStreamPure_StateId_STATE_CARBONATING = 10,
    SMSodaStreamPure_StateId_SATE_CARBONATING_OFF = 11,
    SMSodaStreamPure_StateId_SATE_CARBONATING_ON = 12,
    SMSodaStreamPure_StateId_SATE_START_CARBONATING = 13,
    SMSodaStreamPure_StateId_STATE_EXITFILTERINGONLY = 14,
    SMSodaStreamPure_StateId_STATE_FILTERING = 15,
    SMSodaStreamPure_StateId_STATE_FILTERINGCARBONATIONAWAIT = 16,
    SMSodaStreamPure_StateId_STATE_POWERON = 17,
    SMSodaStreamPure_StateId_STATE_POWERONINIT = 18,
    SMSodaStreamPure_StateId_STATE_READY = 19,
    SMSodaStreamPure_StateId_STATE_READYRINSEREQUIRED = 20,
    SMSodaStreamPure_StateId_STATE_STANDBY = 21,
    SMSodaStreamPure_StateId_STATE_RINSING = 22
} SMSodaStreamPure_StateId;

enum
{
    SMSodaStreamPure_StateIdCount = 23
};
