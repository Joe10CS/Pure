// Autogenerated with StateSmith 0.18.0+34a94a5de0bf3f5f53012c58cebeef3eea5dac04. Last run: 2025-09-09 10:17:56 PM.
...
typedef enum SMSodaStreamPure_EventId
{
    ...
    SMSodaStreamPure_EventId_EVENT_CARBLEVELPRESSED = 3,
...
typedef enum SMSodaStreamPure_StateId
{
    ...
    SMSodaStreamPure_StateId_STATE_POWERONSTANDBYREADY = 15,
    SMSodaStreamPure_StateId_STATE_AWAKE = 16,
    SMSodaStreamPure_StateId_STATE_READY = 17,
    SMSodaStreamPure_StateId_STATE_READYRINSEREQUIRED = 18,
    SMSodaStreamPure_StateId_STATE_SPLASH = 19,
    SMSodaStreamPure_StateId_STATE_POWERONINIT = 20,
    SMSodaStreamPure_StateId_STATE_SETLEVEL = 21,
    SMSodaStreamPure_StateId_STATE_SLEEPING = 22,
    SMSodaStreamPure_StateId_STATE_RINSING = 23
} SMSodaStreamPure_StateId;

enum
{
    SMSodaStreamPure_StateIdCount = 24
};
