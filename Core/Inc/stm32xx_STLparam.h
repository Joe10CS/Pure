...
//YCS
/* Maximum Flash latency at given voltage range */ // YCS
#define MAX_FLASH_LATENCY FLASH_LATENCY_2


/* This is for having self-diagnostic messages reported on a PC via UART */
// YCS #define STL_VERBOSE_POR       /* During Power-on phase only */
// YCS #define STL_VERBOSE           /* During main program execution  */

/* uncoment next lines to configure watchdogs & resets for debug purposes */
#define USE_INDEPENDENT_WDOG
// YCS #define USE_WINDOW_WDOG

/* comment out next lines to remove any eval board control */
// YCS #define STL_EVAL_MODE
...
#define SYSTCLK_AT_STARTUP (uint32_t)(64000000uL)
#define SYSTCLK_AT_RUN_HSI (uint32_t)(64000000uL)
